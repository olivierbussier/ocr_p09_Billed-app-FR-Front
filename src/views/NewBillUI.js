            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input type="date" class="form-control blue-border" data-testid="datepicker">
                  </div>

                  <div class="col-half">
                    <label for="amount" class="bold-label">Montant TTC </label>
                    <input type="number" class="form-control blue-border input-icon input-icon-right" data-testid="amount" placeholder="348">
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <textarea class="form-control blue-border" data-testid="commentary" rows="3">Essai de commentaire</textarea>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="col-half">
                  ...
                  <button type="cancel" id='btn-cancel' class="btn btn-primary">Annuler</button>
                </div>
              </div>
